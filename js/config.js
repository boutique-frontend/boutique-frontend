const CONFIG = {
    ...
    // Profile Picture (Place your image in an 'assets' or 'images' folder in GitHub)
    PROFILE_IMAGE: "assets/logo.jpg", // Update to your image path (e.g. assets/logo.png)
    ...
    // Live embedded Google Map iframe URL
